...
class _ProductListState extends State<ProductList> {
  List<Product> products = [
    ...
    Product(name: "MacBook Air", price: 1099.99),
    ...
    Product(name: "Air Pods Pro", price: 349.99),
    Product(name: "Walton Monitor", price: 129.99),
    Product(name: "Sony Xperia 5 ", price: 799.99),
    Product(name: "Google Chromecast", price: 89.99),
    Product(name: "Samsung 55'' Smart TV", price: 499.99),
  ];
